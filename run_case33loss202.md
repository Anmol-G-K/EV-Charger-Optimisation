...
mpc = case33Loss202(); % Load your custom case

results = runpf(mpc); % Run power flow

printpf(results); % Print results
```
...
12 0.927 -0.179 - - 0.06 0.04  
13 0.921 -0.270 - - 0.06 0.04  
14 0.918 -0.349 - - 0.12 0.08  
15 0.917 -0.386 - - 0.06 0.01  
16 0.916 -0.409 - - 0.06 0.02  
17 0.914 -0.487 - - 0.06 0.02  
18 0.913 -0.496 - - 0.09 0.04  
